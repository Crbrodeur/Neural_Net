...
train_dir_path = Path(r'C:\Users\NG-ML\Johns_sandbox\charlie_data\Data\Dogs_Cats_Update\Partition_Data\Train')
...
def run_test_harness():
    ...
    # prepare iterator
    train_it = datagen.flow_from_directory(train_dir_path,
                                           class_mode='binary', batch_size=32, target_size=(224, 224))
    test_it = datagen.flow_from_directory(val_dir_path,
                                          class_mode='binary', batch_size=32, target_size=(224, 224))
    # fit model
